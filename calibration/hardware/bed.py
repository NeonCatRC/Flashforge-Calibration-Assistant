...
class Bed:
    ...
    # corner: название угла, area_size: количество точек от центра
    ...
    # Получение общей статистики по сетке: (среднее, минимум, максимум)
    ...
    # Получение физического расстояния между точками сетки: (мм по X, мм по Y)
    ...
    # Используем константную плоскость для задач выравнивания,
    # чтобы расчёты стремились к реальному выравниванию, а не к сохранению наклона.
    ...
    # corner_adjustments: {имя_угла: изменение_высоты}
